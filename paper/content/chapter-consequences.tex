...
The question now is how much worse the spectral clustering results become when the vertex basis vectors ${\{ b_i \}}_{1 \leq i \leq N}$ are projected onto $\widetilde{U}_K$ instead of $U_K$.
